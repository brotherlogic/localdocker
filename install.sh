...
kubectl create secret tls registry-certs-secret --cert=./certs/tls.crt --key=./certs/tls.key
kubectl create secret generic registry-auth-secret --from-file=./auth/htpasswd